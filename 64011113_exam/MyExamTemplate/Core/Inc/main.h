...
#define VR_ADC_Pin GPIO_PIN_3
#define VR_ADC_GPIO_Port GPIOF
...
#define TeraTerm_TX_Pin GPIO_PIN_8
#define TeraTerm_TX_GPIO_Port GPIOD
#define TeraTerm_RX_Pin GPIO_PIN_9
#define TeraTerm_RX_GPIO_Port GPIOD
